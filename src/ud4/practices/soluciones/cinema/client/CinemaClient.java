package ud4.practices.soluciones.cinema.client;
...
public class CinemaClient {
    ...
    public CinemaClient(String host, int port) throws IOException {
        ...
        // keytool -export -alias cinema-server -keystore cinema-server.jks -file cinema-server.crt -storepass 123456
        // keytool -import -alias cinema-server -keystore cinema-client.jks -file cinema-server.crt -storepass 123456
